...
SELECT * FROM crime_scene_repor WHERE date = 20180115 AND city = 'SQL City'AND type = 'murder'
  /*Security footage shows that there were 2 witnesses.
    ...
    The second witness, named Annabel, lives somewhere on "Franklin Ave"
     ...
     --118009	64	84	blue	white	male	00NU00	Mercedes-Benz	E-Class 
      ...
      --490173	35	65	green	brown	female	23AM98	Toyota	Yaris7
...
I don't know her name but I know she's around 5'5" (65") or 5'7" (67"). She has red hair and she drives a Tesla Model
S. I know that she attended the SQL Symphony Concert 3 times in December 2017.
Now it seems like there are two suspects: the mind behind the murder and the executor */
 SELECT * FROM drivers_license WHERE car_make LIKE '%Tesla%' AND car_model
...
--So the killer mastermind is Miranda Priestly and the executor is Jeremy Bowers
